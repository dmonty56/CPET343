...
set_location_assignment PIN_AA24 -to seven_seg_out[0]
set_location_assignment PIN_Y23  -to seven_seg_out[1]
set_location_assignment PIN_Y24  -to seven_seg_out[2]
set_location_assignment PIN_W22  -to seven_seg_out[3]
set_location_assignment PIN_W24  -to seven_seg_out[4]
set_location_assignment PIN_V23  -to seven_seg_out[5]
set_location_assignment PIN_W25  -to seven_seg_out[6]
